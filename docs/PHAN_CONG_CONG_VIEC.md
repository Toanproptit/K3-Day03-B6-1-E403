...
| Vai trò (Role)                               | File đảm nhận           | Nhiệm vụ chính                                                                                          | Người đảm nhận (MSSV) |
| :-------------------------------------------- | :------------------------- | :--------------------------------------------------------------------------------------------------------- | :----------------------- |
| **Role 1: Product Architect**           | `config/test_cases.json` | Định hướng bài toán & soạn bộ câu test case                                                       | `Nguyen Van Dat (2A202601969)` |
| **Role 2: Tool Engineer**               | `src/tools.py`           | Định nghĩa các công cụ (Tools) cho Agent                                                             | `Nguyen Kim Trung Duc (2A202601325)` |
| **Role 3: Prompt Engineer**             | `src/prompts.py`         | Viết ReAct System Prompt & phanh Guardrails                                                               | `Nguyen Trong Toan (2A202601493)` |
| **Role 4: Core Developer / Integrator** | `src/app.py`             | **Đầu mối kéo code/file của nhóm (`git pull`), Vibe Code lắp ráp thành App hoàn chỉnh** | `Le Hong Duc (2A202601313)` |
| **Role 4: Core Developer / Integrator** | `src/app.py`             | Đầu mối kéo code/file của nhóm (`git pull`), Vibe Code lắp ráp thành App hoàn chỉnh           | `Hoang Nguyen Phong (2A202601077)` |
| **Role 5: Observability**               | `docs/trace_eval.md`     | Lập bảng Scoring Matrix & Soi nhật ký Trace Log                                                        | `Nguyen Dinh Phuc (2A202601835)` |
| **Role 5: Observability**               | `docs/trace_eval.md`     | Hỗ trợ lập bảng Scoring Matrix & Soi nhật ký Trace Log                                                 | `Kim Duy Hung (2A202601763)` |
